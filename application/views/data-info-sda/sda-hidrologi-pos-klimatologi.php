...
<div class="col-lg-9">
<h2 class="judul-section side merah">Data Hidrologi Pos Klimatologi</h2>

<table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="10" >
    <thead>
        <tr style="font-size:12px;">
            <th data-toggle="true" data-sort-ignore="true" style="width: 20%;">Kode</th>
            <th style="width:15%;" data-sort-ignore="true">Nama Pos Klimatologi</th>
            ...
            <th data-hide="phone" style="width: 15%;" data-sort-ignore="true">Kec</th>
            <th data-hide="phone" style="width: 15%;" data-sort-ignore="true">Tahun</th>
            <th data-hide="phone, tablet" style="width: 25%;" data-sort-ignore="true">Lat</th>
            <th data-hide="phone, tablet" style="width: 25%;" data-sort-ignore="true">Long</th>
    ...
    <div class="form-inline m-b-20" style="margin-bottom:10px; ">
        <div class="row">
            ...
            <div class="col-sm-6 text-xs-center text-right">
                <div class="form-group">
                    <input id="demo-foo-search" type="text" placeholder="Cari Pos klimatologi" class="input-md" autocomplete="on">
                </div>
            </div>
        </div>
    </div>
    ...
    <?php 
      ...
      ?> 
        ...
        ?>
        >
            <td ><?php echo $row->kode_klimatologi ?></td>
            <td ><?php echo $row->nama_klimatologi ?></td>
