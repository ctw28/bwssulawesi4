...
<address>
    <ul>
        <li><strong>BALAI WILAYAH SUNGAI SULAWESI IV KENDARI</strong> <br> Jalan Balai Kota IV No. 01 Kendari,  Sulawesi Tenggara</li>
        <li>Telp: (+62401) 3122818</li>
        <li>Fax: (+62401) 3122818</li>
        <li>Email : <a href="mailto:#">sisdasulawesi4@gmail.com</a></li>
    </ul>                       
</address>                                         
