		    		...
		    		<div style="width: 100%;">
				    	...
				    	<table>
				    		<tr>
					    		...
					    		<td>: Dr.Ir. Haeruddin C. Maddi, ST.,MT</td>
					    	</tr>
					    	<tr>
					    		<td class="profil-items">NIP</td>
				    	...
				    	<h6>Pendidikan : </h6>
				    	<table>
				    		<tr><td>S1/D4 - Pertanian Universitas 45 Makassar, 1992</td></tr>
				    		<tr><td>S1/D4 - teknik Sipil, Universitas Muhammadiyah Makassar, 2005</td></tr>
				    		<tr><td>S3 - Doktor Teknik Sipil, Universitas Hasanuddin, 2018</td></tr>
				    	</table>
				    	<!-- <a class="btn btn-warning btn-custom">Detail</a> -->
		    		</div>
			    </div>
		  	</div>
		</div>
		  	...
		  	<div class="card card-group">
		    	...
		    	<img class="profil-photo card-img-top" src="<?= base_url()?>assets/images/profil/kasubbag.jpg" alt="kepala-bws-sulawesi-4-kendari.jpg">
		    		<div style="width: 100%;">
				    	...
				    	<h6>Pendidikan : </h6>
				    	<table>
				    		<tr><td>S1 - Komputer, STMIK Bina Bangsa, 2011</td></tr>
				    	</table>
				    	<!-- <a class="btn btn-warning btn-custom">Detail</a> -->
		    		</div>
			    </div>
		    	...
		    	<img class="profil-photo card-img-top" src="<?= base_url()?>assets/images/profil/hartina.jpg" alt="kepala-bws-sulawesi-4-kendari.jpg">
		    		<div style="width: 100%;">
				    	...
				    	<table>
				    		<tr>
					    		<td class="profil-items">Nama</td>
					    		<td>: Hj. Hartina Sahabuddin, ST.,MT</td>
					    	</tr>
					    	<tr>
					    		<td class="profil-items">NIP</td>
				    	...
				    	<h6>Pendidikan : </h6>
				    	<table>
				    		<tr><td>S1 - Teknik Sipil Universitas Muslim Indonesia, 1996</td></tr>
				    		<tr><td>S2 - teknik Pengairan, Universitas Brawijaya Malang, 2014</td></tr>
				    	</table>
				    	<!-- <a class="btn btn-warning btn-custom">Detail</a> -->
		    		</div>
			    </div>
		  	...
		  	<div class="card card-group">
		    	...
		    	<img class="profil-photo card-img-top" src="<?= base_url()?>assets/images/profil/seksi-pelaksanaan.jpg" alt="seksi-pelaksanaan.jpg">
		    		<div style="width: 100%;">
				    	...
				    	<h6>Pendidikan : </h6>
				    	<table>
				    		<tr><td>S1 - Teknik Sipil, Sekolah Tinggi Teknologi Mekongga Kolaka, 2007</td></tr>
				    	</table>
				    	<!-- <a class="btn btn-warning btn-custom">Detail</a> -->
		    		</div>
			    </div>
		    	...
		    	<img class="profil-photo card-img-top" src="<?= base_url()?>assets/images/profil/seksi-op.jpg" alt="seksi-op.jpg">
		    		<div style="width: 100%;">
				    	...
				    	<table>
				    		<tr>
					    		<td class="profil-items">Nama</td>
					    		<td>: Annur Ramadhani Asana, S.Si., MT</td>
					    	</tr>
					    	<tr>
					    		<td class="profil-items">NIP</td>
				    	...
				    	<h6>Pendidikan : </h6>
				    	<table>
				    		<tr><td>S1 - Fisika Universitas Hasanuddin, 1999</td></tr>
				    		<tr><td>S1 - teknik Sipil, Universitas Hasanuddin, 2004</td></tr>
				    	</table>
				    	<!-- <a class="btn btn-warning btn-custom">Detail</a> -->
		    		</div>
			    </div>
