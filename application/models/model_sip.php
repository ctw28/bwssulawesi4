...
class Model_sip extends CI_model {
	...
	public function tampil_home_sip()
	{
		return $this->db->query("SELECT * FROM sip_user WHERE username='$key'");
	}
	
	public function tampil_data_user_sip()
	{
				$data="SELECT sip_user.id_user_sip,
				 ...
				 WHERE t_kategori_user_sip.id_kategori_user_sip = sip_user.kategori_user";
		return $this->db->query($data);

	}

	public function tampil_kategori_user_sip()
	{
		return $this->db->query("SELECT * FROM t_kategori_user_sip");
	}
